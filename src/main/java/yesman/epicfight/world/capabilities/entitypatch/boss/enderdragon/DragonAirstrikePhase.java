...
public class DragonAirstrikePhase extends PatchedDragonPhase {
	...
	public void doClientTick() {
		...
		OpenMatrix4f mouthpos = Animator.getBindedJointTransformByName(this.dragonpatch.getAnimator().getPose(1.0F), this.dragonpatch.getEntityModel(AnimatedModels.LOGICAL_CLIENT).getArmature(), "Mouth_Upper");
