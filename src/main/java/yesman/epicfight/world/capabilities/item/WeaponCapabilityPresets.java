...
public class WeaponCapabilityPresets {
	...
	public static final Function<Item, CapabilityItem.Builder> SWORD = (item) -> {
		WeaponCapability.Builder builder = WeaponCapability.builder()
			...
			.newStyleCombo(Styles.ONE_HAND, Animations.SWORD_COMBO1, Animations.SWORD_COMBO2, Animations.SWORD_COMBO3, Animations.SWORD_DASH, Animations.SWORD_AIR_SLASH)
	...
	public static final Function<Item, CapabilityItem.Builder> SPEAR = (item) -> {
		WeaponCapability.Builder builder = WeaponCapability.builder()
			...
			.innateSkill(Styles.TWO_HAND, (itemstack) -> EpicFightSkills.SLAUGHTER_STANCE)
	...
	public static final Function<Item, CapabilityItem.Builder> KATANA = (item) -> {
		WeaponCapability.Builder builder = WeaponCapability.builder()
			...
			.passiveSkill(EpicFightSkills.BATTOJUTSU)
			.hitSound(EpicFightSounds.BLADE_HIT)
			...
			.newStyleCombo(Styles.MOUNT, Animations.SWORD_MOUNT_ATTACK)
			.innateSkill(Styles.SHEATH, (itemstack) -> EpicFightSkills.FATAL_DRAW)
			.innateSkill(Styles.TWO_HAND, (itemstack) -> EpicFightSkills.FATAL_DRAW)
	...
	public static final Function<Item, CapabilityItem.Builder> TACHI = (item) -> {
		WeaponCapability.Builder builder = WeaponCapability.builder()
			...
			.newStyleCombo(Styles.MOUNT, Animations.SWORD_MOUNT_ATTACK)
			.innateSkill(Styles.TWO_HAND, (itemstack) -> EpicFightSkills.LETHAL_SLICE)
