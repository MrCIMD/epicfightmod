...
public class EpicFightMod {
	...
	private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        ((ReloadableResourceManager)resourceManager).registerReloadListener(Meshes.INSTANCE);
        ((ReloadableResourceManager)resourceManager).registerReloadListener(Armatures.INSTANCE);
