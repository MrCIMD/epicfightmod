...
public abstract class TexturedCustomModelParticle extends CustomModelParticle {
	...
	public TexturedCustomModelParticle(ClientLevel level, double x, double y, double z, double xd, double yd, double zd, AnimatedMesh particleMesh, ResourceLocation texture) {
